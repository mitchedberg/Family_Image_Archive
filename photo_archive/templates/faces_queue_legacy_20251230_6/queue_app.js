(function () {
  ...
  function renderAuditPhotos() {
    ...
    state.audit.photos.forEach((photo) => {
      fragment.appendChild(buildAuditPhotoCard(photo));
    });
    auditPhotoList.appendChild(fragment);
  }

  function buildAuditPhotoCard(photo) {
    const card = document.createElement('div');
  ...
  function setPhotoDoneForBucket(bucketPrefix, done) {
